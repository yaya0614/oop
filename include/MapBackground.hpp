...
public:
  explicit MapBackground(int level_id = 0);
  ...
  std::vector<Level> levels{

      {
          {{{-380, -21, -300, -286}, // 底部平台1
            ...
            {-380, -284, 45, 147},    {-200, -110, 168, 209},
      ...
      {{
          {-370, -207, -288, -278}, // IcePool
          {-207, 201, -288, -270},  // 底部平台
          {201, 370, -288, -278},   // 底部平台
          {-370, 370, 270, 270},    // 上方平台（增加厚度）
          {-370, -370, -270, 270},  // 左牆（防掉出左邊）
          {370, 370, -270, 270},    // 右牆（防掉出右邊）
          {-186, -106, -170, -155}, {-186, -106, -45, -31},
          {-186, -104, 77, 92},     {-54, 46, 136, 154},
          {105, 177, -170, -155},   {98, 177, -44, -30},
          {98, 177, 75, 90},        {-254, -253, 158, 173}, // fire pool-1
          {-253, -150, 158, 168},                           // fire pool-2
          {-150, -149, 158, 173},                           // fire pool-3

          {131, 133, 158, 173}, // water pool
          {133, 236, 158, 169}, // water pool
          {236, 238, 158, 173}, // water pool
          {-360, -326, -181, -138}, {-276, -209, -110, -91},
          {-276, -209, -22, -6},    {201, 266, -124, -107},
          {201, 266, -28, -14},     {-211, -187, -268, 158},
          {176, 199, -268, 158},    {-8, 3, -271, -236},
          {-8, 3, -217, -110},      {-8, 3, -88, 10},
          {-8, 3, 28, 135},
      }}
